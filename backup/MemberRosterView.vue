  ...
  <div class="crew-roster">
    <div class="roster-panel">
      <header class="roster-panel__top">
        ...
        <div class="roster-panel__tools">
          <div class="search-box">
            <span class="search-box__icon"><SvgIcon name="search" :size="14" /></span>
            <input
              v-model="keyword"
              type="text"
      ...
      <div class="roster-grid">
        <div v-for="user in filteredUsers" :key="user.id" class="roster-card">
          ...
          <div class="roster-card__actions">
            ...
            >
              <SvgIcon :name="user.active ? 'ban' : 'check'" :size="15" />
            </button>
          </div>
        </div>
      </div>
      ...
      <div v-if="filteredUsers.length === 0" class="empty-state">
        <div class="empty-state__icon"><SvgIcon name="user" :size="48" /></div>
